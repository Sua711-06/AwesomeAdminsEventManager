...
namespace AwesomeAdminsPartyManager.Controllers
{
    public class PartiesController : Controller
    {
        ...
        public PartiesController(AwesomeAdminsPartyManagerContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartyId,Name,Description,EventDate,Location,Owner,Created")] Party party)
        {
            if (id != party.PartyId)
            {
                return NotFound();
